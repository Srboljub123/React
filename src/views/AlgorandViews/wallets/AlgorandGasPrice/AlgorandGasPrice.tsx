    ...
    React.useEffect(() => {
        ...
        const fadeInTimer = setTimeout(() => {
            ...
            fadeOutTimer = setTimeout(() => {
                setEstimatedTotalCost((Number(currentMintPrice) * selectedOption + Number(suggestedGasFees)).toString())
    ...
    return (
        <GasPriceContainer>
            <GasPriceItemContainer>
                <GasPriceItemLeft>{t('payments.wallet.gasFees')}</GasPriceItemLeft>
