...
const config = {
    ...
    devServer: {
        ...
        server: {
            type: 'https',
            options: {
                ca: fs.readFileSync(path.join(__dirname, './certs/CA/CA.pem')), // Certificate Authority
                key: fs.readFileSync(path.join(__dirname, './certs/CA/localhost/localhost.key')), // Decrypted Key only
                cert: fs.readFileSync(path.join(__dirname, './certs/CA/localhost/localhost.crt')), // Certificate
            }
        },
        proxy: {
            '/api': {
